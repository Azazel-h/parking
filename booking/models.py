...
class Booking(models.Model):
    ...
    end_schedule = models.ForeignKey(
        Schedule, on_delete=models.SET_NULL, related_name="end_bookings", null=True, blank=True
    )
    notify_schedule = models.ForeignKey(
        Schedule, on_delete=models.SET_NULL, related_name="notify_bookings", null=True, blank=True
    )
